image:https://circleci.com/gh/spring-cloud-services-samples/dad-joke.svg?style=svg["CircleCI", link="https://circleci.com/gh/spring-cloud-services-samples/dad-joke"]

= Fortune Teller

*Fortune Teller* is a very basic application composed of two services:

. link:dad-joke-fortune-service[Fortune Service] - serves up random Chinese fortune cookie fortunes
. link:dad-joke-ui[Fortune UI] - presents a UI that consumes the fortune service
...
Creating service fortunes-db in org microservices / space dad-joke as admin...
OK
Creating service config-server in org microservices / space dad-joke as admin...
OK
Creating service service-registry in org microservices / space dad-joke as admin...
OK
Creating service circuit-breaker-dashboard in org microservices / space dad-joke as admin...
OK
----
